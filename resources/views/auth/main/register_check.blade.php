            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.main.registered') }}">
                        ...
                        <div class="form-group row">
                            <label for="sponsor_phone" class="col-md-4 col-form-label text-md-right">電話番号</label>
                            <div class="col-md-6">
                                <span class="">{{$user->sponsor_phone}}</span>
                                <input type="hidden" name="sponsor_phone" value="{{$user->sponsor_phone}}">
                            </div>
                        </div>
